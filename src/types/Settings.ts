// At the very top (needed if this is a .ts file)
...
export type Settings = {
  ...
  header?: {
    ...
    /** ✅ NEW: Reset chat button/icon support */
    resetChatIcon?: string | React.FC<React.SVGProps<SVGSVGElement>>;
    showResetChatButtonLabel?: boolean;
  },
  notification?: {
    disabled?: boolean;
  ...
  ariaLabel?: {
    ...
    /** ✅ NEW: Label for the reset button */
